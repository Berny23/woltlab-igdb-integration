...
{capture assign='sidebarRight'}
    <section id="messageBox" class="box{if $showIgdbError} error" >{lang}wcf.IgdbIntegration.page.game_list_igdb_error{/lang}{else} info" >{lang}wcf.IgdbIntegration.page.game_list_info{/lang}{/if}</section>
    <section class="box">
        <form method="post" action="{link controller='IgdbIntegrationGameList'}{/link}">
                ...
                <dl>
                    ...
                    <dd>
                        <select id="sortField" name="sortField">
                            <option value="name" {if $sortField == 'name'} selected{/if}>
        ...
        {foreach from=$objects item=game}
                ...
                <div class="gameInfo">
                    ...
                    <div class="gameUserInfo">
                        ...
                        {if $game->playerCount > 0}
                            <p class="gamePlayerCount pointer{if $game->isOwned == 1} isOwned{/if}"><span
                                    class="icon fa-user"></span> {$game->playerCount}</p>
                        {/if}
                    </div>
                </div>
            </div>
            <script>
                ...
                var dialog = new FormBuilderDialog(
                    'personGameEditDialog{$game->gameId}',
                    ...
                    'getGameUserEditDialog', {
                        ...
                        successCallback(returnValues) {
                            ...
                            if (returnValues.playerCount > 0) {
                                html += '<p class="gamePlayerCount pointer';
