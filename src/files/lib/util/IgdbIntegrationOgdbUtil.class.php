...
final class IgdbIntegrationOgdbUtil
{
	...
	const RULES = [
		...
		['/NEC PC-6001|NEC PC-6601/', ['NEC PC-6000 Series']],
		['/Fujitsu FM-7/', ['FM-7']],
		['/FM-Towns/', ['FM Towns']],
		...
		['/Windows Phone/', ['Win Phone', 'Windows Phone']],
		['/Pocket PC|PalmOS\/Pocket PC/', ['Windows Mobile']],
		...
		['/Nintendo 64/', ['N64', 'Nintendo 64', '64DD']],
		...
		['/New 3DS/', ['New 3DS', 'New Nintendo 3DS', '3DS', 'Nintendo 3DS']],
		...
		['/Mega CD|Sega CD|Mega-LD/', ['Sega CD']],
		['/32X/', ['Sega32', 'Sega 32X']],
		...
		// NEC / SNK / others
		['/PC Engine|TurboGrafx/', ['turbografx16', 'TurboGrafx-16/PC Engine', 'Turbografx-16/PC Engine CD']],
		...
		['/NeoGeo Pocket(?! Color)/', ['Neo Geo Pocket']],
